...
import Birendra_Ku_Behera from '../assets/staff_photos/Birendra_Ku_Behera.jpg'; // Principal's photo
function AboutUs() {
  // Add carousel state
          ...
          <div className="max-w-7xl py-5 mx-auto">
            <div className="flex flex-col md:flex-row gap-8">
              ...
              <div className="md:w-1/3 flex flex-col items-center">
                <div className="w-48 h-56 md:w-56 md:h-72 bg-gray-200 rounded-xl overflow-hidden shadow-md mb-4">
                  <img 
                  ...
                  <div className="text-center">
                    ...
                    <p className="text-white flex items-center justify-center"></p>
